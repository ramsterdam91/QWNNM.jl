...
function patEstimation(NL_mat::Array{Int32,2}, Self_arr::Array{Int32,1}, Sigma_arr::Array{Float32,2}, CurPat::Array{Float32,3}, Par::PAR)
    Depth = size(CurPat)[3]
    ...
    for i = 1 : length(Self_arr)
        ...
        Temp    =   Temp .- M_Temp
        E_Temp 	=   WNNM(Temp, Par.c, Sigma_arr[Self_arr[i], :], M_Temp)
